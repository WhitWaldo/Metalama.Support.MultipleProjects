...
{
    /// <summary>
    /// Populate the Autofac container builder with the set of registered service descriptors and makes <see cref="IServiceProvider"/>
    /// and <see cref="IServiceScopeFactory"/> available in the container.
    /// </summary>
