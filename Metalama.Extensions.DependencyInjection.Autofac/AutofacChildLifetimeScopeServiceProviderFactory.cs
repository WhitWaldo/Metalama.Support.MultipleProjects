...
public class AutofacChildLifetimeScopeServiceProviderFactory : IServiceProviderFactory<AutofacChildLifetimeScopeConfigurationAdapter>
{
    ...
    public AutofacChildLifetimeScopeServiceProviderFactory(Func<ILifetimeScope> rootLifetimeScopeAccessor,
    ...
    /// <param name="configurationAction">Action on a <see cref="ContainerBuilder"/> that adds component registrations to the container.</param>
    /// <exception cref="ArgumentNullException"></exception>
    public AutofacChildLifetimeScopeServiceProviderFactory(ILifetimeScope rootLifetimeScope,
        Action<ContainerBuilder> configurationAction = null)
    {
